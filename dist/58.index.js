...
const { readdirSync, statSync } = __webpack_require__(57147);
...
const args = (__webpack_require__(13280).wrap)(null)
...
const emojiRegex = __webpack_require__(58390);
...
const {Yargs, processArgv} = __webpack_require__(66809);
...
function Argv(processArgs, cwd) {
  const argv = Yargs(processArgs, cwd, __webpack_require__(98050));
  singletonify(argv);
...
const parser = new YargsParser({
    ...
    require: (path) => {
        if (true) {
            return __webpack_require__(35670)(path);
        }
        else {}
    }
});
